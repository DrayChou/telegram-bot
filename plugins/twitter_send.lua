...
local consumer_key = twitter_config.consumer_key
local consumer_secret = twitter_config.consumer_secret
local access_token = twitter_config.access_token
local access_token_secret = twitter_config.access_token_secret
